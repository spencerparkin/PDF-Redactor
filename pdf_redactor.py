...
offending_words_list = [
    ...
    # Note that I add some misspellings here, because tesserract sometimes sees 'n' instead of 'r'.
    OffendingWord('jesus', MatchMode.WHOLE),
    OffendingWord('christ', MatchMode.WHOLE),
    OffendingWord('christ\'s', MatchMode.WHOLE),
    OffendingWord('christ’s', MatchMode.WHOLE),
    OffendingWord('chnist\'s', MatchMode.WHOLE),
    OffendingWord('chnist’s', MatchMode.WHOLE),
...
def main():
    source_pdf_path = 'D:/git_repos/PDF-Redactor/TheAndromedaStrain.pdf'
